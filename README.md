...
```
┌💁  jcleng @ 💻  nixos in 📁  mywork
└❯ neofetch 
          ▗▄▄▄       ▗▄▄▄▄    ▄▄▄▖            jcleng@nixos 
          ▜███▙       ▜███▙  ▟███▛            ------------ 
           ▜███▙       ▜███▙▟███▛             OS: NixOS 24.11.714685.36864ed72f23 (Vicuna) x86_64 
            ▜███▙       ▜██████▛              Host: LENOVO LNVNB161216 
     ▟█████████████████▙ ▜████▛     ▟▙        Kernel: 6.13.3 
    ▟███████████████████▙ ▜███▙    ▟██▙       Uptime: 4 days, 7 hours, 30 mins 
           ▄▄▄▄▖           ▜███▙  ▟███▛       Packages: 1771 (nix-system), 359 (nix-user), 183 (flatpak) 
          ▟███▛             ▜██▛ ▟███▛        Shell: bash 5.2.37 
...
# nixos-install 的substituters没有了, 安装的时候换源需要写到用户配置目录
